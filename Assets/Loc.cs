...
public class Loc : MonoBehaviour
{
    ...
    public void EnglishLanguage()
    {
        ...
        //Start screen
        UI_START.text = "PLAY"; UI_START.fontSize = 28; UI_START.font = englishFontChangaOutline;
        UI_RESET.text = "RESET"; UI_RESET.fontSize = 28; UI_RESET.font = englishFontChangaOutline;
        UI_OPTIONS.text = "SETTINGS"; UI_OPTIONS.fontSize = 28; UI_OPTIONS.font = englishFontChangaOutline;
    ...
    public void RussianLanguage()
    {
        ...
        //100%Completion
        UI_CONGRATS.text = "ПО3ДРАВЛЯЕМ"; UI_CONGRATS.fontSize = 25; UI_CONGRATS.font = englishFontChanga;
        UI_COMPLETION.text = "100% 3АВЕРШЕНИЕ"; UI_COMPLETION.fontSize = 16; UI_COMPLETION.font = englishFontChanga;
        UI_THANKSOFRPLAYING.text = "СПАСИБО 3А ИГРУ!"; UI_THANKSOFRPLAYING.fontSize = 15; UI_THANKSOFRPLAYING.font = englishFontChanga;
    }
    #endregion
    ...
    public void PolishLanguage()
    {
        ...
        UI_EXIT.text = "WYJDZ"; UI_EXIT.fontSize = 28; UI_EXIT.font = englishFontChangaOutline;

        //Inside Options
        UI_OPTIONSETTINGS.text = "OPCJE"; UI_OPTIONSETTINGS.fontSize = 36; UI_OPTIONSETTINGS.font = englishFontChanga;
        UI_FULLSCREEN.text = "PELNY EKRAN"; UI_FULLSCREEN.fontSize = 19; UI_FULLSCREEN.font = englishFontChanga;
        ...
        UI_ON.text = "WL."; UI_ON.fontSize = 32; UI_ON.font = englishFontChanga;
        UI_OFF.text = "WYL."; UI_OFF.fontSize = 29; UI_OFF.font = englishFontChanga;
        UI_F_ON.text = "WL."; UI_F_ON.fontSize = 32; UI_F_ON.font = englishFontChanga;
        UI_F_OFF.text = "WYL."; UI_F_OFF.fontSize = 29; UI_F_OFF.font = englishFontChanga;

        //WishToReset?
        UI_WISHTORESET.text = "RESETOWAC?"; UI_WISHTORESET.fontSize = 40; UI_WISHTORESET.font = englishFontChanga;
        ...
        UI_COMPLETION.text = "100% UKONCZENIA"; UI_COMPLETION.fontSize = 16; UI_COMPLETION.font = englishFontChanga;
        UI_THANKSOFRPLAYING.text = "DZIEKUJEMY ZA GRE!"; UI_THANKSOFRPLAYING.fontSize = 15; UI_THANKSOFRPLAYING.font = englishFontChanga;
    }
    #endregion
    ...
    public void TurkishLanguage()
    {
        ...
        //WishToReset?
        UI_WISHTORESET.text = "SIFIRLAMAK ISTIYOR MUSUNUZ?"; UI_WISHTORESET.fontSize = 21; UI_WISHTORESET.font = englishFontChanga;
        ...
        //100%Completion
        UI_CONGRATS.text = "TEBRIKLER"; UI_CONGRATS.fontSize = 35; UI_CONGRATS.font = englishFontChanga;
        UI_COMPLETION.text = "100% TAMAMLANMA"; UI_COMPLETION.fontSize = 16; UI_COMPLETION.font = englishFontChanga;
        UI_THANKSOFRPLAYING.text = "OYUN OYNADIGINIZ IÇIN TESEKKÜRLER!"; UI_THANKSOFRPLAYING.fontSize = 11; UI_THANKSOFRPLAYING.font = englishFontChanga;
    }
    #endregion
